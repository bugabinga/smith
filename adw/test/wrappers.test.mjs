...
test("Phase 5 plan preserves pre-hold history and records the ninth signed rollback", async () => {
  const plan = await readFile(phase5Plan, "utf8");
  ...
  assert.match(plan, /Current `origin\/main` is signed ninth rollback `9a5d2caeefbf1cd23ec7ee90045a9655676cf8bd`/);
...
test("Phase 5 records all nine rolled-back cutovers and blocks completion claims", async () => {
  const plan = await readFile(phase5Plan, "utf8");
...
test("Phase 5 preserves prior history and binds tenth-retry commands to PR #178", async () => {
  ...
  assert.match(task12, /30884816241.*30884990977.*30885142692.*9a5d2ca/is);
