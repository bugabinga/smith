...
test("Phase 5 plan preserves pre-hold history and records the fifth signed rollback", async () => {
  ...
  assert.match(plan, /Current `origin\/main` is signed fifth rollback `6c9a656c66b38b8bf4771ad47a79fab8bd617bba`/);
...
test("Phase 5 records all five rolled-back cutovers and blocks completion claims", async () => {
  const plan = await readFile(phase5Plan, "utf8");
