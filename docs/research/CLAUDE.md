...
- Do not reference SPEC sections or old spec IDs from research. Keep research reusable.
...
- Do not vendor external repos into this jj repo.
- Store external sparse clones under `~/.pi/research/repos/`.
