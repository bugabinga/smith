...
Read `AGENTS.md` for project context and the spec index.
...
If a topic has no spec: create `docs/spec-<topic>.md`.
If a topic has a spec: edit the existing `docs/spec-sm-*.md`.
